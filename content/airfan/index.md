...
<div class="prevnext">
  ...
  <h5><a href="../{{url.post-id--07}}" rel="next">{{name.post-id--07}}<i class="icon icon-8 icon-arrow-right"><svg class="shape-icon" viewBox="0 0 8 12"><use xlink:href="#shape-arrow-point"></use></svg></i></a></h5>
</div>
