...
" lang="en">
 ...
 @else
    ...
    <link href="{{ $page->baseUrl }}{{ ('assets/css/style.min.css?v2') }}" rel="stylesheet" media="print" onload="this.media='all'">
    <noscript><link href="{{ $page->baseUrl }}{{ ('assets/css/style.min.css?v2') }}" rel="stylesheet"></noscript>
  @endif
  </head>
